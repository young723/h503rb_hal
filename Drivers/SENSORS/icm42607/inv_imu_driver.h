...
#define INV_DRIVER_NAME  "icm4n607 mcu concise driver"
#define INV_MAJOR_VERSION   1
#define INV_MINOR_VERSION   3
#define INV_PATCH_VERSION   0


/* List whoami values for all  variants*/
...
#define APEX_CONFIG2_MREG     (icm_dev.chip_version == ICM_REV_A)? 0x1044:0x1046
...
#define APEX_CONFIG3_MREG     (icm_dev.chip_version == ICM_REV_A)? 0x1045:0x1047
...
#define APEX_CONFIG4_MREG     (icm_dev.chip_version == ICM_REV_A)? 0x1046:0x1048
...
#define APEX_CONFIG5_MREG     (icm_dev.chip_version == ICM_REV_A)? 0x1047:0x1049
...
#define APEX_CONFIG9_MREG     (icm_dev.chip_version == ICM_REV_A)? 0x1048:0x104a
...
#define APEX_CONFIG10_MREG    (icm_dev.chip_version == ICM_REV_A)? 0x1049:0x104b
...
#define APEX_CONFIG11_MREG    (icm_dev.chip_version == ICM_REV_A)? 0x104a:0x104c
...
#define ACCEL_WOM_X_THR_MREG  (icm_dev.chip_version == ICM_REV_A)? 0x104b:0x104d
#define ACCEL_WOM_Y_THR_MREG  (icm_dev.chip_version == ICM_REV_A)? 0x104c:0x104e
#define ACCEL_WOM_Z_THR_MREG  (icm_dev.chip_version == ICM_REV_A)? 0x104d:0x104f
#define OFFSET_USER0          (icm_dev.chip_version == ICM_REV_A)? 0x104e:0x1050
#define OFFSET_USER1          (icm_dev.chip_version == ICM_REV_A)? 0x104f:0x1051
#define OFFSET_USER2          (icm_dev.chip_version == ICM_REV_A)? 0x1050:0x1052
#define OFFSET_USER3          (icm_dev.chip_version == ICM_REV_A)? 0x1051:0x1053
#define OFFSET_USER4          (icm_dev.chip_version == ICM_REV_A)? 0x1052:0x1054
#define OFFSET_USER5          (icm_dev.chip_version == ICM_REV_A)? 0x1053:0x1055
#define OFFSET_USER6          (icm_dev.chip_version == ICM_REV_A)? 0x1054:0x1056
#define OFFSET_USER7          (icm_dev.chip_version == ICM_REV_A)? 0x1055:0x1057
#define OFFSET_USER8          (icm_dev.chip_version == ICM_REV_A)? 0x1056:0x1058

#define ST_STATUS1_MREG       (icm_dev.chip_version == ICM_REV_A)? 0x1063:0x1066
#define ST_STATUS2_MREG       (icm_dev.chip_version == ICM_REV_A)? 0x1064:0x1067

#define FDR_CONFIG_MREG       (icm_dev.chip_version == ICM_REV_A)? 0x1066:0x1069
...
#define APEX_CONFIG12_MREG    (icm_dev.chip_version == ICM_REV_A)? 0x1067:0x106a
...
void inv_data_handler(AccDataPacket *AccDatabuff,GyroDataPacket *GyroDatabuff,chip_temperature *chip_temper,bool polling);
