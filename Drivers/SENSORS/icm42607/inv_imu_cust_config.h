...
#define DATA_FORMAT_DPS_G                    0  // output sensor data with unit in default  accel: m/s2  gyro: rad/s  

#define SUPPORT_SOFT_RESET                   1    // if VCO_CODE<=7 set this to 1 , other wise set to 0 to use otp_reload method
...
#define SENSOR_LOG_TS_ONLY                   0 //only print log sensor data TS  , FIFO Timestampe is only available in fifo mode
