...
#define QMP6988_IOSETUP_REG                 0xF5  /* IO SETUP Register */
...
extern int qmp6988_init(void);
extern void qmp6988_get_data(float *tempearture, float *press);
