...
//#define QMI8658_FIRMWARE_DOWNLOAD
...
#if 1//defined(QMI8658_FIRMWARE_DOWNLOAD)
...
extern void qmi8658_get_chip_info(unsigned int info[3]);
extern unsigned char qmi8658_init(int protocol);
extern void qmi8658_config_acc(enum qmi8658_AccRange range, enum qmi8658_AccOdr odr, enum qmi8658_LpfConfig lpfEnable, enum qmi8658_StConfig stEnable);
extern void qmi8658_config_gyro(enum qmi8658_GyrRange range, enum qmi8658_GyrOdr odr, enum qmi8658_LpfConfig lpfEnable, enum qmi8658_StConfig stEnable);
...
extern void qmi8658_read_xyz_raw(short acc[3], short gyro[3]);
extern void qmi8658_read_xyz(float acc[3], float gyro[3]);
extern void qmi8658_read_imu_raw(float imu[6], short raw[6]);
...
extern int qmi8658_send_ctl9cmd(enum qmi8658_Ctrl9Command cmd, unsigned int d_ms);
